...
from Model_sparse import TransGNN as Model
...
# os.environ["WANDB_API_KEY"] = "591a109d49937fbaffd6855a0e3cb18298914e444"
...
class Coach:
    ...
    def trainEpoch(self):
        ...
        for i, tem in enumerate(trnLoader):
            ...
            ceLoss = self.model.calcLosses(drugs, genes, labels, self.handler.torchBiAdj, args.edgeSampRate)
            # bprloss
