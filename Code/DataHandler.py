...
class DataHandler:
    ...
    def LoadData(self):
        ...
        trnData = TrnData(trnMat,train_labels, d_train_idx, g_train_idx)
...
class TrnData(data.Dataset):
    def __init__(self, coomat, train_labels, d_train_idx, g_train_idx):
        ...
        args.user, args.item = coomat.shape
    ...
    def __getitem__(self, idx):
        ...
        # return self.d_train_idx[idx], self.g_train_idx[idx], self.train_labels[idx], self.rows[idx], self.cols[idx], self.negs[idx]
